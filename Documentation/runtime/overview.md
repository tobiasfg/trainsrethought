...
## Key Concepts
- Events drive runtime behavior.
- Global objects like `game`, `script`, and `rendering` expose APIs.
- `storage` is the canonical place for persistent mod data.

## Where to Look Next
- `auxiliary/overview.md` for lifecycle and advanced topics.
- `prototype/overview.md` for data-stage context.
