...
## Key Concepts
- Prototypes are templates for entities, items, recipes, and more.
- Types are shared data shapes used across prototypes.
- The `data` table is the primary entry point for adding/modifying prototypes.

## Where to Look Next
- `prototype/data-raw/index.md` for the base game prototype catalog.
- `runtime/overview.md` for control stage scripting.
