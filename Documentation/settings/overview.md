...
## Key Concepts
- Settings stage runs at game start-up and defines setting prototypes.
- Settings are defined in prototype-like structures for startup/runtime access.
- Settings values can influence both data stage and runtime behavior.

## Where to Look Next
- `settings/mod-settings.md` for the full tutorial and properties.
- `prototype/overview.md` for data stage prototyping.
